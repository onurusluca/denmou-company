<template>
  ...
  >
    <ul class="left" >
      <li class="nav-element"><a href="#why">どうして？</a></li>
      <li class="nav-element"><a href="#how">過程</a></li>
      <li class="nav-element"><a href="#whousesit">事業</a></li>
      <li class="nav-element"><a href="#pricing">価格設定</a></li>
    </ul>
...
-11 15 -14 16 -15 3z"
    ...
    <ul class="right">
      <li class="nav-element"><a href="">お客様の声</a></li>
      <li class="nav-element"><a href="">お問い合わせ</a></li>
      <li class="nav-element"><a href="">ログイン</a></li>
    </ul>
  </div>
</template>
...
.navbar.scroll-nav {
  ...
  box-shadow: 0 2px 10px rgba(205, 205, 205, 0.5);
}
#navbar {
  display: flex;
  flex-direction: row;
